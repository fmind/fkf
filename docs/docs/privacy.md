...
Directories are created `0700`, ordinary files `0600`, and executable helpers and hooks under `bin/` and `tests/` `0700`. Nothing in a base is world-readable by construction, because the whole directory is personal data by construction.
